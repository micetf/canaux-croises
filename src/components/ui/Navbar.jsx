 ...
 *   - Ajout d'un bouton d'aide (?) qui ouvre HelpModal
 *   - HelpModal gere la fermeture au clic exterieur et a l'Echap
 */
export function Navbar({ toolName = "Canaux croises" }) {
    ...
    return (
        <>
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            (window.location.href =
                                                "mailto:webmaster@micetf.fr?subject=A propos de /canaux-croises")
                                        }
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
            ...
            {/* Modal d'aide -- rendu hors du flux de la nav */}
...
/**
 * HelpIcon -- icone point d'interrogation SVG inline.
 */
function HelpIcon() {
    return (
        <svg
